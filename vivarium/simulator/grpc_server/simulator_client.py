...
def state_proto_to_nve_state(state):
...
class SimulatorGRPCClient(SimulatorClient):
    ...
    def get_nve_state(self):
        ...
        return state_proto_to_nve_state(state)
    ...
    def step(self):
        self.state = state_proto_to_nve_state(self.stub.Step(Empty()))
        return self.state
