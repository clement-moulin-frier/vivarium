...
def env_to_sim_state(env_state):
    sim_state = None 
    return sim_state
    
def sim_to_env_state(sim_state):
    env_state = None 
    return env_state
...
class Simulator:
    ...
    # Neighbor functions
    # TODO : No more update neighbor functions in the simulator
