...
for _ in range(num_steps):
    simulator.state, simulator.neighbors = simulator.step(simulator.state, simulator.neighbors)
    nve_states.append(state.nve_state)
...
# At the momet the saving and the loading works but 
