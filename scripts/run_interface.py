...
parser.add_argument("--notebook_mode", type=str, default="False", help='Run in notebook mode.')
...
if args.notebook_mode == "True":
    ...
    raise ValueError(f"Invalid value for notebook_mode: {args.notebook_mode}. Use either 'True' or 'False'.")
